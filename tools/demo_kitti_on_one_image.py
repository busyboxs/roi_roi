...
def generate_evaluate_txt(net, image_name):
    ...
    save_root = '/home/yangshun/PycharmProjects/roi_roi/output/roi_txt/data/'
...
if __name__ == '__main__':
    ...
    prototxt = '/home/yangshun/PycharmProjects/roi_roi/models/kitti/VGG16/roi_roi345/' \
               'test.prototxt'
    caffemodel = '/home/yangshun/PycharmProjects/roi_roi/output/roi_345/kittivoc_train/' \
    ...
    kitti_test_root = '/media/yangshun/0008EB70000B0B9F/Datasets/KITTI/data_object_image_2/KITTI/training/image_2'
    #
